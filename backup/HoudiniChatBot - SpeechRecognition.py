...
SVG_MIC_DEFAULT = """
<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#888888" viewBox="0 0 16 16">
  <path d="M8 11a3 3 0 0 0 3-3V4a3 3 0 0 0-6 0v4a3 3 0 0 0 3 3z" fill="#CCCCCC"/>
  <path d="M5 8a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5A.5.5 0 0 1 5 8z" fill="#888888"/>
  <path d="M8 0a2 2 0 0 1 2 2v4a2 2 0 0 1-4 0V2a2 2 0 0 1 2-2z" fill="#AAAAAA"/>
  <path d="M3.5 9A.5.5 0 0 1 4 9.5v.5h8v-.5a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5V10a5 5 0 0 1-5 5h-1a5 5 0 0 1-5-5v-.5a.5.5 0 0 1 .5-.5h1z" fill="#666666"/>
</svg>
"""
...
class ChatbotPanel(QtWidgets.QWidget):
    ...
    def init_ui(self):
        ...
        # Input area with text, Send, Mic (voice input), and Cancel buttons.
    ...
    def voice_input(self):
        ...
        # Disable the mic button during voice input
        self.mic_button.setEnabled(False)
        
        # Set mic icon to active blue state
        ...
        try:
            ...
            self.error_display.setText("Voice input received.")
        
        except sr.WaitTimeoutError:
            self.error_display.setText("No speech detected. Timed out.")
        
        except sr.UnknownValueError:
            self.error_display.setText("Could not understand audio.")
        
        except sr.RequestError:
            self.error_display.setText("Could not request results from speech recognition service.")
        
        except Exception as e:
            self.error_display.setText(f"Voice recognition error: {str(e)}")
        
        finally:
            # Always reset mic button, regardless of outcome
            self.mic_button.setIcon(self.icon_mic_default)
